...
const ServicesSection = () => {
  ...
  return (
    <div className="bg-[#F9FAEF] py-16   sm:px-6 lg:pr-0">
      <div className="max-w-1420 mx-auto">
        <div className="max-w-7xl mx-auto grid grid-cols-1 md:grid-cols-2 gap-8 mb-24 px-10">
          <div className="text-center md:text-left">
            <h1 className="max-w-614px text-4xl sm:text-5xl font-bold text-gray-900">
              COMPREHENSIVE HIGH-GRADE SOLUTIONS FOR YOUR BRAND
            </h1>
          </div>
          <div className="text-center md:text-right flex items-center justify-end">
            <p className="text-lg text-[#F9FAEF]">
              SERVICES WE PROVIDE
            </p>
          </div>
        </div>
